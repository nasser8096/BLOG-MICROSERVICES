...
import { invalidateCacheJob } from "../Rabbitmq/producers/cachePublisher.js";
import { GoogleGenAI } from "@google/genai";
import { GoogleGenerativeAI } from "@google/generative-ai";

export const createBlog = TryCatch(async(req:AuthenticatedRequset , res)=>{
...
export const updateBlog = TryCatch(async (req: AuthenticatedRequset, res) => {
    const { id } = req.params;
    const { title, description, blogcontent, category } = req.body;
  ...
  export const deleteBlog = TryCatch(async (req: AuthenticatedRequset, res) => {
